...
public class TechTableRecipe implements IRecipe {
	...
	public TechTableRecipe(int recipeWidth, int recipeHeight, ItemStack[] recipeInput, ItemStack recipeOutput,
	...
	private boolean checkMatch(InventoryCrafting par1InventoryCrafting, IInventory recipeItemInventory, int par2,
		...
		for (int k = 0; k < 3; ++k) {
			for (int l = 0; l < 3; ++l) {
				...
				if (itemstack1 != null || itemstack != null) {
					...
					if (recipeItem.getItem() == this.recipeItem.getItem() && recipeItem.getItemDamage() != this
							.recipeItem.getItemDamage()) {
						return false;
					}
				}
			}
